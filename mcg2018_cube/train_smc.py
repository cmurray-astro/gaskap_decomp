# Modified by Claire Murray based on train--grs.py by Manuel Riener
...
train.dirpath_gpy = "decomposition"
#  Filepath to the training set.
train.path_to_training_set = os.path.join(
    train.dirpath_gpy, "gpy_training", "smc_field-training_set_100_spectra.pickle"
)
